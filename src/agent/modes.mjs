export const MODES = {
  ...
  ask: {
    ...
    systemPrompt: `You are a read-only assistant. You may only use read-only tools.
  ...
  orchestrator: {
    ...
    systemPrompt: `You are an orchestrator agent. Break down complex requests into clear sub-tasks.
    Create task DAGs, delegate to sub-agents, and monitor progress.
    Handle failures by reassigning or adjusting the plan.
    Summarize results when all tasks are done.`,
  },
};
